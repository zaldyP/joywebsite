...
<ul id="dropdown2" class="dropdown-content">
  ...
  if($ucount == 1 && $u['role'] == 'writer' OR $u['role'] == 'admin' ){
    echo '<li><a href="index.php">Members</a></li>';  
  }
  ...
  <nav class="light-blue lighten-1" role="navigation">
    ...
    right: -16px; font-weight: 600; font-size: 18px; font-family: 'Source Sans Pro', sans-serif;  "><?php echo $u['username']; ?></span><i class="material-icons right">arrow_drop_down</i></a></li>
      ...
      <div class="background">
        <img src="<?php if(isset($u['coverpic']) & !empty($u['coverpic'])){ echo $u['coverpic']; }else{ echo "https://images.pexels.com/photos/635874/pexels-photo-635874.jpeg?w=940&h=650&auto=compress&cs=tinysrgb";} ?>">
      </div>
